<div id="header">
    <div class="container">
        ...
        <img class="imgheder" src="/static/images/bbc.jpg">
        <h2>TOP OF THE <span class="pink-text">WORLD</span></h2>
    </div>
    <div class="container" style="background-color: white">
        <div class="progress">
            <div id="row" class="row">
                <div class="col-sm-2 col-md-2 col-lg-2" title="Home"><a href="../home"><strong>Home</strong></a></div>
                <div class="col-sm-2 col-md-2 col-lg-2" title="About Us"><a href="#"><strong>About Us</strong></a></div>
                <div class="col-sm-2 col-md-2 col-lg-2" title="You Should Know"><a href="#"><strong>You Should Know</strong></a></div>
                <div class="col-sm-2 col-md-2 col-lg-2" title="Contact Us"><a href="#"><strong>Contact Us</strong></a></div>
                <div class="col-sm-2 col-md-2 col-lg-2"><a href="#"><strong></strong></a></div>
                <div class="col-sm-2 col-md-2 col-lg-2"><a href="#"><strong></strong></a></div>
            </div>
        </div>
